@extends('employer.user.layouts.app')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Đổi mật khẩu</div>
                    ...
                    @endif
                <div class="card-body">
                    <form method="POST" action="{{ route('employer.postChangePassword') }}">
                        {{ csrf_field() }}
                        
                        <div class="form-group row">
                            <label for="current_password" class="col-sm-4 col-form-label text-md-right">{{ __('Mật khẩu cũ') }}</label>
