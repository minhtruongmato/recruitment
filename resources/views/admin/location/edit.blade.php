		...
		<div class="col-md-12">
			<div class="box">
				<div class="box-header">
					<h3 class="box-title">Cập Nhật Nơi Làm Việc</h3>
					@if(Session::has('error'))
						<p class="alert {{ Session::get('alert-class', 'alert-warning') }}">{{ Session::get('error') }}</p>
					@endif
				</div>
				<div class="box-body">
					<form action="{{ route('location.update', ['id' => $result->id]) }}" method="post" enctype="multipart/form-data">
						{{ method_field('PUT') }}
						{{ csrf_field() }}
						<div class="row">

							<div class="form-group row">
								<label class="col-md-2 col-form-label text-md-right" for="title">Tên Nơi Làm Việc</label>
								<div class="col-md-9">
