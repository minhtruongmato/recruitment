...
<section class="content">
    <div class="box">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-6"><a class="btn btn-primary" href="{{ route('field.create') }}">Thêm mới lĩnh vực</a></div>
                <div class="col-sm-6">
                    <form method="get" action="{{ route('field.index') }}">
                        <div class="row">
        ...
        <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                    ...
                    <table class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd row-{{$value->id}}" >
                                ...
                                <td>{{ $value->slug }}</td>
                                <td>
                                    <a href="{{ route('field.edit', ['id' => $value->id]) }}" style="margin: 0px 10px; color: #f0ad4e" title="Chỉnh Sửa">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">Hiển thị  lĩnh vực</div>
                </div>
                <div class="col-sm-7">
