...
<section class="content">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Danh Sách Trình Độ Học Vấn</h3>
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-6"><a class="btn btn-primary" href="{{ route('education.create') }}">Thêm mới trình độ học vấn</a></div>
                <div class="col-sm-6">
        ...
        <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                    ...
                    <table class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd row-{{$value->id}}" >
                                ...
                                <td>{{ $value->slug }}</td>
                                <td>
                                    <a href="{{ route('education.edit', ['id' => $value->id]) }}" style="margin: 0px 10px; color: #f0ad4e" title="Chỉnh Sửa">
                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                    </a>
                                    <a href="javascript:void(0)" style="margin: 0px 10px; color: #d9534f" class="btn-remove" data-id="{{ $value->id }}" data-url="{{ route('education.remove', ['id' => $value->id]) }}" title="Xóa">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">Hiển thị  trình độ học vấn</div>
                </div>
                <div class="col-sm-7">
